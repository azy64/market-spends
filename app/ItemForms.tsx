...
const ItemFormsScreen = () => {
  ...
  const shoppingModel: ShoppingList = {
    id: "",
    name: "",
    items: [],
    createdAt: "",
  ...
  const [updatedShoppingList, setUpdatedShoppingList] =
    React.useState(shoppingModel);
  const nav = useRouter();
  ...
  return (
    <View>
      <Text style={styles.header}>
        <Icon source="cart-variant" size={20} />
        Add Item
      </Text>
      <View>
